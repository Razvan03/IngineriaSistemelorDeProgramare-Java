...
public class SafeHomeTest {
    ...
    public void instantiateDoorController() {
        ...
        try {
            c.addTenant("pin1", "name1");
        } catch (Exception ex) {
            
            fail("No exception should be added while creating new tenant" + ex);
        }
    }
    ...
    public void whenWrongPinThrowInvalidPinException() {
        try {
            ...
            fail("No exception should be added while creating new tenant" + ex.getStackTrace()[3].toString());
        }
